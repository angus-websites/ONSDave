<template>
    <div :class="messageClass">
        <div class="flex items-center">
            ...
            <button v-if="showDismiss" @click="dismiss" type="button" :class="closeColour" class="ms-auto -mx-1.5 -my-1.5 rounded-lg focus:ring-2 p-1.5  inline-flex items-center justify-center h-8 w-8 dark:bg-gray-800  dark:hover:bg-gray-700"  aria-label="Close">
